    ...
    <div className="glass-card p-6 space-y-6 w-full text-slate-900">
      ...
      <div className="flex items-center justify-between border-b border-slate-200/80 pb-4">
        <div className="flex items-center gap-2">
          <SlidersHorizontal className="w-5 h-5 text-primary-700 animate-pulse-slow" />
          <h3 className="font-bold text-lg tracking-wide">Refine Search</h3>
        </div>
        <button
          type="button"
          onClick={onClearFilters}
          className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 hover:text-rose-400 transition-colors"
        >
